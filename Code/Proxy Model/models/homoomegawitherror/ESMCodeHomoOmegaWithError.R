...
#   Version 2 - Homogeneous Omega with error in scale
#
#* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
setwd("/Users/rogerbailey/Dropbox/Models/HomoOmegaWithError")
...
Prior=list(Deltabar=Deltabar, ADelta=ADelta, omegabar=omegabar, 
           Aomega=Aomega, deltabar=deltabar, Adelta=Adelta, nub=nub, Vb=Vb, nul=nul, Vl=Vl)
...
mean(tester)
#run the program
source("ESMEstHomoOmegaWithError.R")
output=ESMHomoOmegaWithError(data,Prior,MCMC,sim,Tvals)
