...
Omega=cbind(double(nresp*ntask)+1,matrix(runif(nresp*ntask*nTR),nc=nTr))

#true gammas
tgamma=matrix(rnorm(nTr+1)+2,nc=1)
...
tdeltalambdabar=c(runif(1)-.5,runif(1)*1/ntask,(runif(2)-1)*1/ntask) 
